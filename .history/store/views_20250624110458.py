...
from django.contrib import messages
from django.shortcuts import render, redirect
from .models import DeliveryDriver, Delivery  # Assuming you have a Delivery model
from django.contrib.auth.decorators import login_required
...
def driver_dashboard(request):
    ...
    # Get recent deliveries (for example, the last 5 deliveries)
    recent_deliveries = Delivery.objects.filter(driver=driver).order_by('-date')[:5]
